package com.genfu.agent.client;
...
import com.genfu.agent.mxbeans.ConfigNetworkMXBean;
...
public class Client {
    ...
    public static void main(String[] args) {
        try {
            ...
            //
            ObjectName mbeanName = new ObjectName("com.genfu.agent.mxbeans:type=ConfigNetwork");
            System.out.println("\nCreate ConfigNetwork MBean...");
            mbsc.createMBean("com.genfu.agent.mxbeans.ConfigNetwork", mbeanName, null, null);
...
//                              new Attribute("State", "changed state"));
            ...
            // server connection
            //
            ConfigNetworkMXBean proxy = JMX.newMBeanProxy(
                    mbsc, mbeanName, ConfigNetworkMXBean.class);
