...
jQuery("#groupOrderItem").jqGrid({
	...
	datatype: "json",
   	...
   	colModel:[
   		{name:'id',index:'id', width:55, editable:false, sorttype:'integer',summaryType:'count', summaryTpl : '({0}) total'},
   		{name:'orderId',index:'orderId', width:100, sorttype:'integer'},
   		{name:'dishId',index:'dishId', width:90, sorttype:'integer'},
   		{name:'orderItemName',index:'orderItemName', width:100},
   		{name:'price',index:'price', width:80,align:"right",sorttype:'currency',formatter:'currency', summaryType:'sum'},
   		{name:'amount',index:'amount', width:80, align:"right", sorttype:'integer',formatter:'integer',summaryType:'sum'},
   		{name:'total',index:'total', width:55, align:"right",sorttype:'currency', width:100,search:false,
   		...
   		{name:'staffNumber',index:'staffNumber', width:100, sorttype:'integer'},
   		{name:'kitchener',index:'kitchener', width:100},
   		{name:'createdAt',index:'createdAt',sorttype:'date', width:90,searchrules:{date:true}, search:true},
   		{name:'updatedAt',index:'updatedAt',sorttype:'date', width:90},
