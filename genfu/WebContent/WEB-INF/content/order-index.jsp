...
jQuery("#order_header").jqGrid({
	...
	datatype: "json",
   	...
   	colModel:[
   		...
   		{name:'createdAt',index:'createdAt', formatter:dishDatefmt, formatoptions: {newformat: 'Y-m-d H:i:s'}, width:100},
...
jQuery("#order_detail").jqGrid({
	...
	//height: 290, 
   	...
   	colModel:[
   		...
   		{name:'price',index:'price', width:55, align:"right",formatter:'number', width:100, searchtype:"number",editable:true,editoptions:{readonly:true}},
