...
<body>
	<s:actionmessage />
	<div class="demo">
		<s:form method="post" action="%{#ctx}/actor-info">
			<table class="datepickers">
				<tr>
					<td><s:textfield name="id" label="id" /></td>
				</tr>
				<tr>
					<td><s:textfield name="actorDescription" label="actorDescription" />
					</td>
				</tr>
				<tr>
					<td><s:textfield name="actorFlag" label="actorFlag"></s:textfield>
					</td>
				</tr>
				<tr>
					<td><s:textfield id="uppperActorId" name="uppperActorId"
