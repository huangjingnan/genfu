	...
	$(function() {
		$("#userExpDate,#userEffDate")
				.datepicker(
						{
							showOn : "button",
							buttonImage : "${ctx}/js/jquery-ui-1.8.20.custom/development-bundle/demos/images/calendar.gif",
...
<body>
	<div class="demo">
		<s:form method="post" action="%{#ctx}/actor-info/%{id}">
			...
			<table class="datepickers">
				...
				<tr>
					<td><p>
							<s:textfield name="actorDescription" label="actorDescription" />
						</p></td>
				</tr>
				<tr>
					<td><p>
							<s:textfield name="actorUpdateDate" label="actorUpdateDate"></s:textfield>
						</p></td>
				</tr>
				<tr>
					<td><p>
							<s:textfield id="uppperActorId" name="uppperActorId"
								label="uppperActorId">
							</s:textfield>
						</p></td>
				</tr>
