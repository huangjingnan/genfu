...
<body>
	<div class="demo">
		<s:form method="post" action="%{#ctx}/department/%{id}">
			...
			<table class="datepickers">
				...
				<tr>
					<td><p>
							<s:textfield name="departmentName" label="departmentName" />
						</p></td>
				</tr>
				<tr>
					<td><p>
							<s:textfield name="updateDate" label="updateDate"></s:textfield>
						</p></td>
				</tr>
				<tr>
					<td><p>
							<s:textfield id="upId" name="upId"
								label="upId">
							</s:textfield>
						</p></td>
				</tr>
