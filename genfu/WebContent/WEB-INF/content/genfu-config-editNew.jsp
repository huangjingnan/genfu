...
jQuery("#configListUpgrade").jqGrid({ 
	...
	datatype: "json", 
	height: 250, 
	colNames:['configId','configKey', 'configDescription', 'configOthers','configCreatedAt','configFlag','configParentId', 'configEffDate', 'configUpdatedAt','configSrc','configValue'],
	colModel:[
   		{name:'id',index:'id', width:55,editable:true,editoptions:{readonly:true,size:10}},
   		{name:'configKey',index:'configKey', width:80,editable:true,editoptions:{size:10}},
   		...
   		{name:'configFlag',index:'configFlag', width:80, editable: true,align:"left",edittype:"select",editoptions:{value:"OPEN:OPEN;CLOSED:CLOSED"}},
   		...
   		{name:'configUpdatedAt',index:'configUpdatedAt',width:100,align:"center"},	
   		{name:'configSrc',index:'configSrc', width:90,editoptions:{size:25}},
   		{name:'configValue',index:'configValue', width:60,editoptions:{size:10}}
   	],
   	rowNum:20,
   	rowList:[20,30,50],
...
jQuery("#configListUpgrade").jqGrid('navGrid','#pconfigListUpgrade',{edit:true,add:false,del:true},
