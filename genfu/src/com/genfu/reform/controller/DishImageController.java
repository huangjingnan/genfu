...
public class DishImageController extends ValidationAwareSupport implements
	...
	private List<File> coverImages = new ArrayList<File>();
	private List<String> coverImageFileNames = new ArrayList<String>();
	private List<String> coverImageContentTypes = new ArrayList<String>();
	...
	public void setUpload(List<File> uploads) {
		this.coverImages = uploads;
	}

	public List<String> getUploadFileName() {
		return this.coverImageFileNames;
	}

	public void setUploadFileName(List<String> uploadFileNames) {
		this.coverImageFileNames = uploadFileNames;
	}

	public List<String> getUploadContentType() {
		return this.coverImageContentTypes;
	}

	public void setUploadContentType(List<String> contentTypes) {
		this.coverImageContentTypes = contentTypes;
	}
